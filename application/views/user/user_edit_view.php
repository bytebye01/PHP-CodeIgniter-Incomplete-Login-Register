<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <hr>
            <?php if ($rsedit): ?>
                <form action="<?php echo site_url('user/central_management/editing');?>" method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="editUser(); return false;">
